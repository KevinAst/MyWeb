...
- ALL scripture references now support the reddish-tinted arrow, that
  takes you to the FireWithin Book for that scripture.  Previously
  scriptures with a dedicated Bible translation did not support this.
  This was an internal enhancment, where all scriptures are now
