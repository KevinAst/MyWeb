...
<!-- ?? class zoomE - full-screen zoomE ?? figcaption works great too <<< SIMPLEST TECHNIQUE -->
...
<!-- ?? test zoom image -->
<!-- ?? zoomE DOES WORK HERE TOO - ***HOWEVER*** the image is humongous and still does the mouse traking -->

<!-- ?? TRASH
<div id="zoomC"
     class="diagram zoomE"></div>
 -->
<!-- ?? NO work ... not sure why
     style="background: url("Acts-Luke.jpg");"></div>
 -->
...
<link rel="stylesheet" href="zoom.css"> <!-- ?? this could go in our global css   -->
